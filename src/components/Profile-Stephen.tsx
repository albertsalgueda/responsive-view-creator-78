  ...
  return <div ref={ref} className={cn("h-full inline-flex min-w-[480px]", className)}>
        <div className="flex items-start gap-6 h-full">
          ...
          <div className="flex flex-col justify-end h-[40vh]">
            <h3 className="text-text-large-desktop font-barlow font-black italic whitespace-nowrap leading-heading" style={{
          color: textColor,
          transition
        }}>{name}</h3>
            <p className="text-text-medium font-barlow font-medium mt-2 whitespace-nowrap leading-standard" style={{
          color: textColor,
          transition
        }}>{role}</p>
            <p className="text-text-small font-barlow font-medium mt-2 max-w-[40vh] leading-standard" style={{
          color: textColor,
          transition
        }}>{bio}</p>
