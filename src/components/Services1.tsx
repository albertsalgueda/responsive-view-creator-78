...
const Services1 = ({
  ...
  columns = '"We need to look and feel unique"<p>"We have a great product but no brand story"<p>"We want to create a new category"<p>"We need to standout in a crowded marketplace"<p>"We need to look like a billion dollar company"'
}: Services1Props) => {
  ...
  return <section className={`w-full relative px-0 py-0 overflow-hidden font-barlow mb-0 ${isMobile ? 'h-fit' : 'h-screen'}`}>
      <div className="w-full mx-auto h-full p-0 flex flex-col">
        {isMobile ? <div className="grid grid-cols-3 gap-4 px-6 h-full py-16">
            <div className="col-span-3 mt-8 mb-16">
