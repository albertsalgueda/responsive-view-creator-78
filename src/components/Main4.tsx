...
const Main4 = ({
  ...
  return <section className={`w-full relative px-0 py-0 overflow-hidden font-barlow mb-0 ${isMobile ? 'h-auto' : 'h-screen'}`}>
      <div className="max-w-7xl w-full mx-auto h-full p-0">
        {isMobile ? <div className="grid grid-cols-3 gap-4 h-auto py-16 px-6">
            ...
            <div className="col-start-2 col-span-2 mt-8 mb-8 fade-in-delay-2 font-barlow font-medium text-text-small" style={{
          lineHeight: 1.1,
          color: textColor,
          transition: transition
        }}>
