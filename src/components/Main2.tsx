      ...
      <div className="max-w-7xl w-full mx-auto h-full p-0">
        {isMobile ? <div className="flex flex-col min-h-screen justify-between py-12 px-6">
            <div className="mt-16">
              ...
              <div className="mt-8 fade-in-delay-2 max-w-[66%] font-barlow font-medium ml-auto text-left">
                <p className="p-medium" style={{
                  color: textColor,
                  transition: transition
                }}>
              ...
              <div className="h-full flex flex-col justify-between">
                ...
                <div className="grid grid-cols-3 gap-12">
                  <div className="col-span-1 col-start-2 flex flex-col justify-end">
                    <div className="slide-in-right font-barlow font-medium mb-0">
                      <p className="p-medium" style={{
                        color: textColor,
                        transition: transition
                      }}>
