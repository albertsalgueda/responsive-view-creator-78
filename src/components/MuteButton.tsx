...
const MuteButton = ({
  ...
  return <div className="fixed bottom-0 right-0 p-2" style={{
    ...
    zIndex: 999999
      ...
      <button onClick={onToggle} className="w-[40px] h-[40px] bg-white rounded-md hover:bg-accent hover:text-accent-foreground hover:opacity-80 transition-all duration-500">
        {isMuted ? <svg width="40" height="40" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
