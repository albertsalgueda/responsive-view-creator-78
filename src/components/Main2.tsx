          ...
          <div className="flex flex-col min-h-screen justify-between py-12">
            ...
            {ctaText && (
              <div className="mb-16 fade-in-delay-2 flex justify-end">
                <button
                  onClick={ctaAction}
                  className="bg-[#FFB889] text-[#2A0C41] px-6 py-3 rounded-sm font-medium hover:bg-opacity-90 transition-all font-barlow"
                >
                  {ctaText}
                </button>
              </div>
          ...
          <div className="flex flex-col justify-between h-full py-12">
            <div className="flex-1 grid grid-cols-2 gap-20">
              ...
              <div className="col-span-1 flex flex-col justify-center gap-20">
                <p className="text-[#FFB889] text-2xl slide-in-right font-barlow font-medium">
                  {subtitle}
                </p>
            ...
            {ctaText && (
              <div className="fade-in mt-4 flex justify-end">
                <button
                  onClick={ctaAction}
                  className="bg-[#FFB889] text-[#2A0C41] px-6 py-3 rounded-sm font-medium hover:bg-opacity-90 transition-all font-barlow"
                >
