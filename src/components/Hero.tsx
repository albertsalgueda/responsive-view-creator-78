...
const Hero = ({
  ...
  return <section className={`w-full bg-brand-pink relative px-6 py-8 overflow-hidden font-barlow mb-10 ${isMobile ? 'min-h-screen' : 'h-screen'}`}>
      <div className="max-w-7xl w-full mx-auto h-full">
        {isMobile ?
      // Mobile layout
      <div className="flex flex-col min-h-screen justify-between py-12">
            <div className="mt-16">
              <h1 className="text-6xl font-extrabold text-brand-blue slide-in-left font-barlow" style={{
            lineHeight: 1,
            fontWeight: 800,
            fontStyle: 'italic'
          }}>
      ...
      <div className="flex flex-col h-full justify-between py-12">
            ...
            fontWeight: 800,
            fontStyle: 'italic'
          }} className="text-9xl text-brand-blue slide-in-left font-barlow font-extrabold">
                {title}
              </h1>
            </div>
          </div>}
