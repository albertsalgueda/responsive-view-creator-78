...
const Main2 = ({
  ...
  return <section className={`w-full relative px-0 py-0 overflow-hidden font-barlow mb-0 ${isMobile ? 'min-h-screen' : 'h-screen'}`}>
      <div className="max-w-7xl w-full mx-auto h-full p-0">
        {isMobile ? <div className="flex flex-col min-h-screen justify-start py-12 px-6">
            <div className="mt-16">
            ...
            {ctaText && <div className="mb-16 mt-auto fade-in-delay-2 flex justify-end">
          ...
          </div> : <div className="flex flex-col justify-start h-full px-6 pt-[144px] pb-[40px]">
            <div className="flex-1">
              <div>
                ...
                color: textColor,
                transition: transition
              }} className="text-[4.5rem] font-extrabold slide-in-left font-barlow mt-0 my-0">
                  {title}
                </h1>
              </div>
            ...
            {ctaText && <div className="fade-in mt-auto flex justify-end mb-6">
                <button onClick={ctaAction} className="text-[#2A0C41] px-6 py-3 rounded-sm font-medium hover:bg-opacity-90 transition-all font-barlow" style={{
            backgroundColor: textColor,
            transition: transition
          }}>
