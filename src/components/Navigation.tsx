...
const Navigation = ({
  ...
  const MobileMenu = () => (
    <Drawer open={open} onOpenChange={setOpen}>
      ...
      <DrawerContent className="h-[90vh] border-none pb-6" style={{ 
        backgroundColor: backgroundColor,
        transition: transition
      }}>
        <DrawerTitle className="sr-only">Navigation Menu</DrawerTitle>
        
        <div className="flex flex-col h-full justify-between pt-6 px-6">
          <div className="flex flex-col items-start pt-8">
            <DrawerClose asChild>
              <Button variant="ghost" size="icon" className="absolute right-4 top-3 p-2">
