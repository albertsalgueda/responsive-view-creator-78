      ...
      <div className="max-w-7xl w-full mx-auto h-full">
        {isMobile ? (
          <div className="flex flex-col min-h-screen justify-between py-12 px-6">
            <div className="mt-16">
              <h1 className="text-[4.5rem] font-extrabold slide-in-left font-barlow" 
                style={{
                  lineHeight: 1,
                  fontWeight: 800,
                  fontStyle: 'italic',
              ...
              <p className="mt-6 text-xl fade-in-delay-1 max-w-[90%] font-barlow font-medium" 
                style={{
                  color: textColor,
                  transition: transition
                }}
          ...
          <div className="flex flex-col h-full justify-between px-6 pt-[112px] pb-[40px]">
            ...
            <div>
              ...
              <h1 
                ...
                className="text-[10vw] font-extrabold slide-in-left font-barlow"
              >
                {title}
              </h1>
            </div>
