...
const Main2 = ({
  ...
  return <section className={`w-full relative px-0 py-0 overflow-hidden font-barlow mb-0 ${isMobile ? 'h-auto' : 'h-screen'}`}>
      <div className="max-w-7xl w-full mx-auto h-full p-0">
        {isMobile ? <div className="grid grid-cols-3 gap-4 py-16 px-6">
          ...
          transition: transition
              ...
              <p className="mb-8">{text2}</p>
            </div>
            {ctaText && <div className="col-span-3 mt-auto mb-8 fade-in-delay-2 flex justify-end">
