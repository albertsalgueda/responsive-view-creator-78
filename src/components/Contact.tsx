      ...
      <div className="w-full mx-auto h-full">
        {isMobile ? (
          ...
          <div className="flex flex-col min-h-screen justify-between p-6">
            <div className="mt-16">
              <h2 className="text-[2.5rem] font-bold text-[#FFB0C9] slide-in-left font-barlow" style={{
                lineHeight: 1.1,
                fontWeight: 700,
              }}>
                {title}
            ...
            <div className="flex items-start pt-12 flex-1 py-0 w-full">
              <div className="w-full grid grid-cols-2 gap-12">
                <div className="col-span-1">
                  <h2 className="text-[4rem] font-bold text-[#FFB0C9] slide-in-left font-barlow" style={{
                    lineHeight: 1.1,
                    fontWeight: 700,
                  }}>
                    {title}
