...
const ProfileCraig = forwardRef<HTMLDivElement, ProfileProps>(
  ({ 
    ...
    return (
      <div 
        ref={ref}
        className={cn("h-full inline-flex flex-col justify-end min-w-[480px]", className)}
      >
        <div className="flex items-start gap-6">
          ...
          <div className="flex flex-col justify-end h-[30vh]">
            ...
            >{role}</p>
            <p 
              className="text-text-small font-barlow font-medium mt-2 max-w-[35vh] leading-standard"
              style={{ color: textColor, transition }}
            >{bio}</p>
