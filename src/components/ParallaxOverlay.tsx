  ...
  return (
    <div className="fixed inset-0 pointer-events-none z-10 overflow-hidden">
      <div className="relative w-full h-full">
        ...
        <div 
          style={getParallaxStyle(1.2)}
          className="absolute font-barlow font-bold tracking-tighter text-[18px] top-[15%] left-[480%]"
        >
          OUR
        </div>
        ...
        <div 
          style={getParallaxStyle(1.1)}
          className="absolute font-barlow font-bold tracking-tighter text-[18px] top-[45%] left-[440%]"
        >
          SERVICES
        </div>
        ...
        <div 
          style={getParallaxStyle(0.9)}
          className="absolute font-barlow font-bold tracking-tighter text-[18px] top-[65%] left-[390%]"
        >
          ARE
        </div>
      </div>
