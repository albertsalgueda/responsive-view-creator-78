          ...
          <div className="flex flex-col min-h-screen justify-between p-6">
            <div className="mt-16">
              ...
              <div className="mt-6 fade-in-delay-2">
                <a href={callToAction}>
                  <Button 
                    className="hover:bg-opacity-80 transition-all font-barlow px-6 py-3 rounded-sm font-medium text-base" 
                    style={{
            ...
            <div className="pb-16">
              <div 
                className="my-8 border-t opacity-30" 
                style={{
              ...
              <div className="flex justify-between items-center">
                ...
                <div className="flex flex-col items-end gap-2">
                  <a 
                    ...
                    className="font-barlow text-sm hover:underline" 
                    style={{
                      color: textColor,
                      transition: transition
                    }}
