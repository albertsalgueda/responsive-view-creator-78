...
const Navigation = ({
  links = [
    { text: "why we're here", href: "#video" },
    { text: "what we do", href: "#main2" },
    { text: "who we are", href: "#main3" },
          ...
          <div className="flex flex-col gap-8 items-start w-full">
            {links.map((link, index) => (
              <a 
                key={index} 
                href={link.href} 
                className="text-2xl font-barlow hover:opacity-80 transition-all text-brand-blue font-medium"
        ...
        <div className="flex items-center gap-8">
          {links.map((link, index) => (
            <a 
              ...
              style={{ color: navColor, transition: 'color 1.2s ease-out', lineHeight: 1.2 }}
            >
              {link.text}
            </a>
          ))}
