  ...
  return <section className={`w-full relative px-0 py-0 overflow-hidden font-barlow mb-0 ${isMobile ? 'min-h-screen' : 'h-screen'}`}>
      ...
      <div className="flex flex-col min-h-screen justify-between p-6">
            ...
            transition: transition
              ...
              <div className="mt-6 fade-in-delay-2">
                <a href={callToAction}>
                  <Button className="hover:bg-opacity-80 transition-all font-barlow px-6 py-3 rounded-sm font-medium text-base" style={{
            ...
            transition: transition
              ...
              <div className="mt-6 w-full px-1" style={{
            color: textColor,
            transition: transition
          }}>
                <Logo />
      ...
      <div className="flex flex-col h-full justify-between pt-[25vh] pb-[40px] px-[40px]">
            ...
            transition: transition
              ...
              <div className="w-full max-w-[600px] px-4" style={{
            color: textColor,
            transition: transition
          }}>
                <Logo />
