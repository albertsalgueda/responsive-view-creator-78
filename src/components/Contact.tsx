...
const Contact = ({
  ...
  return <section className={`w-full bg-[#0A2DD1] relative px-0 py-0 overflow-hidden font-barlow mb-0 ${isMobile ? 'min-h-screen' : 'h-screen'}`}>
      <div className="w-full mx-auto h-full">
        {isMobile ?
      // Mobile layout
      <div className="flex flex-col min-h-screen justify-between p-6 py-0">
            <div className="mt-16">
            ...
            lineHeight: 1.1
              ...
              <div className="mt-6 fade-in-delay-2">
                <a href={callToAction}>
                  <Button className="bg-[#FFB0C9] text-[#0A2DD1] hover:bg-[#FFB0C9]/80 transition-all font-barlow px-6 py-3 rounded-sm font-medium text-base">
                    {callToActionText}
                  </Button>
                </a>
              </div>
