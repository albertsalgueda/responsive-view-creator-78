      ...
      <div className="max-w-7xl w-full mx-auto h-full">
        {isMobile ? (
          ...
          <div className="flex flex-col min-h-screen justify-between py-12">
            <div className="mt-16">
              <h1 className="text-6xl font-extrabold text-brand-blue slide-in-left font-barlow" style={{ lineHeight: 1, fontWeight: 800 }}>
                {title}
              </h1>
          ...
          <div className="flex flex-col h-full justify-between py-12">
            ...
            <div>
              ...
              <h1 className="text-9xl font-extrabold text-brand-blue slide-in-left font-barlow" style={{ lineHeight: 1, fontWeight: 800 }}>
                {title}
              </h1>
            </div>
          </div>
